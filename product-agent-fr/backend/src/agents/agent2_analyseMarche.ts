...
import type { AnalyseProduit, AnalyseMarche } from './types'
...
export async function runAnalyseMarche(produit: AnalyseProduit): Promise<AnalyseMarche> {
...
Retourne un objet JSON avec ce schéma exact :
{
  ...
  return appelAgent<AnalyseMarche>(SYSTEME, prompt, 1500)
}
