...
exports.runPlanContenu = runPlanContenu;
...
async function runPlanContenu(produit, avatar) {
...
Retourne un objet JSON avec ce schéma exact :
{
  ...
  "calendrier_contenu": [
    ...
    return (0, llm_1.appelAgent)(SYSTEME, prompt, 3500);
}
//# sourceMappingURL=agent8_contenu.js.map